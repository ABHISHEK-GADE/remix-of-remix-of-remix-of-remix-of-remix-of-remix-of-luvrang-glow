    ...
    <section className="section-spacing bg-primary/5">
      <div className="container-luxury">
        <div className="text-center mb-12">
          <h2 className="font-display text-2xl md:text-3xl font-bold text-foreground">Current Offers</h2>
          <p className="font-body text-muted-foreground mt-2 text-sm">Don't miss out on these deals</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {offers.map((offer) => (
            <Link
              key={offer.title}
              to={offer.link}
              className="bg-background rounded-xl p-6 shadow-soft hover-lift text-center group"
            >
